        ...
        <header className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-stone-500 font-light leading-relaxed">
              Explore thousands of recipes from around the globe. <br className="hidden md:block" />
              From quick bites to gourmet feasts.
            </p>
          </div>
          <div className="hidden md:block">
             <Button variant="outline" className="rounded-full px-6 border-stone-200 text-stone-600 hover:text-orange-600 hover:border-orange-200 transition-colors">
        ...
        {recipeOfTheDay && (
          <section className="mb-24 md:mb-32">
             <div className="flex items-center gap-3 mb-8">
                ...
                <span className="text-sm font-semibold tracking-wider text-stone-500 uppercase">Daily Highlight</span>
            </div>
            ...
            >
              <div className="bg-white rounded-[2rem] p-4 md:p-6 shadow-xl shadow-stone-200/50 border border-stone-100 transition-all duration-500 hover:shadow-2xl hover:shadow-orange-100/50 hover:border-orange-200/50">
                <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-center">
                  ...
                  <div className="lg:col-span-5 flex flex-col justify-center order-2 lg:order-1 px-4 md:px-6 pb-4 md:pb-6 lg:py-8">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold text-stone-900 mb-6 leading-tight group-hover:text-orange-600 transition-colors duration-300">
                      {recipeOfTheDay.strMeal}
                    </h2>

                    <p className="text-stone-500 mb-8 line-clamp-3 leading-relaxed text-base md:text-lg">
                      {recipeOfTheDay.strInstructions?.substring(0, 180)}...
                    </p>

                    <div className="flex items-center gap-4 mt-auto">
                        <Button size="lg" className="rounded-full bg-stone-900 text-white hover:bg-orange-600 transition-colors duration-300 px-8 h-12 text-base">
                            View Recipe
                        </Button>
                         <div className="hidden sm:flex -space-x-2 overflow-hidden">
                             {/* Mock avatars for social proof visuals */}
                            {[1,2,3].map((i) => (
                                <div key={i} className={`inline-block h-8 w-8 rounded-full ring-2 ring-white bg-stone-200 items-center justify-center text-[10px] text-stone-500 font-medium`}>
                                   <ChefHat className="w-4 h-4" />
                                </div>
                            ))}
                            <div className="h-8 w-8 rounded-full ring-2 ring-white bg-stone-100 flex items-center justify-center text-[10px] text-stone-500 font-medium pl-1">
                                +
                            </div>
                         </div>
                         <span className="text-xs text-stone-400 hidden sm:block">Cooked by others</span>
                    </div>
                  </div>
        ...
        <section className="mb-24 md:mb-32">
          <div className="flex items-end justify-between mb-10 md:mb-12">
            <div>
                ...
                <p className="text-stone-500">Curated collections for every craving</p>
            </div>
             <Link href="/categories" className="text-sm font-medium text-orange-600 hover:text-orange-700 flex items-center gap-1 transition-colors">
        ...
        <section className="pb-12">
           <div className="mb-10 md:mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mb-3">
             ...
             <p className="text-stone-500">Travel the world from your kitchen text-stone-500</p>
          </div>
